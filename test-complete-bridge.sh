...
sqlite3 /home/ubuntu/.openclaw/workspace/Alfred-Mission-Control/data/kanban.db << SQL
...
TASK_ID=$(sqlite3 /home/ubuntu/.openclaw/workspace/Alfred-Mission-Control/data/kanban.db "SELECT id FROM kanban_tasks WHERE description LIKE '%[Opportunity: Test Complete Bridge]%' AND status = 'backlog' LIMIT 1")
sqlite3 /home/ubuntu/.openclaw/workspace/Alfred-Mission-Control/data/kanban.db << SQL
UPDATE kanban_tasks 
