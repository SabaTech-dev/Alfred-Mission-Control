...
function DockItems(): DockItem[] {
  return [
    ...
    // Alfred's unique pages
    { href: "/actions", labelKey: "dock.actions", helpKey: "help.actions", icon: Zap },
    { href: "/calendar", labelKey: "dock.calendar", helpKey: "help.calendar", icon: Calendar },
    { href: "/costs-alerts", labelKey: "dock.costs-alerts", helpKey: "help.costs-alerts", icon: AlertTriangle },
    { href: "/handoffs", labelKey: "dock.handoffs", helpKey: "help.handoffs", icon: Hand },
