...
export const BRANDING = {
  ...
  agentName: process.env.NEXT_PUBLIC_AGENT_NAME || "Alfred",
  ...
  ownerUsername: process.env.NEXT_PUBLIC_OWNER_USERNAME || "joker",
  ...
  companyName: process.env.NEXT_PUBLIC_COMPANY_NAME || "AlfredTeam",

  // App title (shown in browser tab)
  appTitle: process.env.NEXT_PUBLIC_APP_TITLE || "Alfred — Mission Control",
} as const;
