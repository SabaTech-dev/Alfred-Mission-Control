...
<body>
  <div class="header">
    ...
    <div class="period">${escapeHtml(report.period.start)} — ${escapeHtml(report.period.end)}</div>
  </div>
  ...
  <div class="footer">
    Generated by Alfred on ${escapeHtml(new Date(report.data.generatedAt).toLocaleString())}
  </div>
</body>
</html>`;
}
