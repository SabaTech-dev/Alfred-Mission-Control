...
const WORKFLOWS: Workflow[] = [
  ...
  },
  {
    ...
    steps: [
      ...
      "Selecciona 5-7 noticias más relevantes para el nicho para Joker",
  ...
  },
  {
    ...
    steps: [
      ...
      "Evalúa si el trend es relevante para el canal para Joker",
  ...
  },
  {
    ...
    steps: [
      ...
      "Selecciona tema con mayor potencial de engagement para la audiencia para Joker",
      "Redacta post de LinkedIn en la voz para Joker (profesional-cercano, sin emojis ni hashtags)",
  ...
  },
  {
    ...
    description: "Digest curado de las newsletters del día. Consolida lo mejor de las suscripciones para Joker en un resumen accionable.",
  ...
  },
  {
    ...
    description: "Categoriza y resume los emails del día para que Joker empiece la jornada sin inbox anxiety.",
    schedule: "7:45h (cada día)",
    trigger: "cron",
    status: "active",
    steps: [
  ...
  },
  {
    ...
    status: "active",
    steps: [
      "Joker envía /cfo, /cmo, /cto, /legal, /growth, /coach o /producto",
      "Alfred carga el skill advisory-board/SKILL.md",
      "Lee el archivo de memoria del advisor correspondiente (memory/advisors/)",
      "Responde en la voz y personalidad del advisor con contexto para Joker",
  ...
  },
  {
    ...
    status: "active",
    steps: [
      "Comprueba si hay cambios en el workspace de Alfred",
  ...
  },
  {
    ...
    steps: [
      ...
      "Notifica a Joker por Telegram con el resumen de lo implementado",
    ],
  },
];
