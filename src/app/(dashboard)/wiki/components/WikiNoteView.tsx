/**
 * Wiki note content display — header, backlinks, markdown preview, and empty state.
 */
"use client";

import { BookMarked, Clock, FileText, Link2, Tag } from "lucide-react";

import { MarkdownPreview } from "@/components/MarkdownPreview";

import { formatDate, formatSize } from "../utils/wikiUtils";
import type { NoteData, BacklinkResult } from "../types";

interface WikiNoteViewProps {
