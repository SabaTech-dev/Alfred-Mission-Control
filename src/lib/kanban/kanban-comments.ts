/**
 * Kanban Comment Validation & Rate Limiting
 * Structured comment handling, secret detection, and rate limiting.
 * Note: DB-level comment CRUD lives in kanban-task-comments.ts.
 */
